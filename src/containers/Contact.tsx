      ...
      <Row className="content d-flex align-items-center justify-content-center">
        <Col xl={9}>
          <div className="title text-primary text-center mb-4">
            {viewportSize.isDesktop && <h1 className="fira-mono">Let&apos;s Build Something Awesome!</h1>}
            {viewportSize.isMobile && <h2 className="fira-mono">Let&apos;s Build Something Awesome!</h2>}
          </div>
          <div className="info text-center">
            ...
            {viewportSize.isMobile && (
              <h5 className="mb-4">Have an exciting project or questions that you want to discuss?</h5>
            )}
            <Button size="sm" onClick={handleChatClicked}>
